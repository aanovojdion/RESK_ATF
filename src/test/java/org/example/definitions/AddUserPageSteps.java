...
public class AddUserPageSteps extends Context {
    private final AddUserPage addUserPage = new AddUserPage(driver);
    private final String addUserPageUrl = PropertyLoader.getProperty("ADD_USER_URL");
    ...
    public void userIsNotRegistered() {
        ...
        assertEquals(addUserPageUrl, driver.getCurrentUrl());
