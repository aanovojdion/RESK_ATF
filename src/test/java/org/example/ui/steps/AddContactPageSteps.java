...
public class AddContactPageSteps {
    ...
    private final AddContactPage addContactPage = new AddContactPage((scenarioContext.getContext(DRIVER, WebDriver.class)));
    ...
    public void theAddContactPageIsDisplayed() {
        ...
        assertEquals(addContactUrl, (scenarioContext.getContext(DRIVER, WebDriver.class)).getCurrentUrl());
